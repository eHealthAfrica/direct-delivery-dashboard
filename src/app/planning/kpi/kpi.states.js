...
angular.module('planning').config(function ($stateProvider) {
  $stateProvider.state('planning.kpi', {
    ...
    resolve: {
      deliveryRound: function (log, planningService, $stateParams) {
        ...
        return planningService.getByRoundId($stateParams.roundId).catch(handleError)
      },
      kpiTemplates: function (kpiService) {
        return kpiService.getAllTemplates().catch(function () {
